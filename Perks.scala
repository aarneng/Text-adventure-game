...
class Perks {
  var damage = (5, "Your ability to show the ladies (or gentlemen, or people beyond a binary scale) how tough you are. Mostly used to kill monsters though")
  ...
  var mouthAriditySpotsLeft = (2, "The amount of coctails and drinks you can gulp down")
  var livesLeft = 3
